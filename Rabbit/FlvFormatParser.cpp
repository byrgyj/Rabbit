...
FlvFormatParser::FlvFormatParser(int operation) : mTagIndex(0), mOperation(operation)
{
    _pFlvHeader = NULL;
	mAes = new AES(key);
}
...
FlvFormatParser::FlvHeader *FlvFormatParser::CreateFlvHeader(unsigned char *pBuf)
{
...
void FlvFormatParser::Tag::Init(TagHeader *pHeader, unsigned char *pBuf, int nLeftLen)
{
...
FlvFormatParser::Tag *FlvFormatParser::CreateTag(unsigned char *pBuf, int nLeftLen)
{
	TagHeader header;
