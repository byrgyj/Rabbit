...
unsigned char* AES::encryptData(unsigned char* input)
{
...
unsigned char* AES::decryptData(unsigned char* input)
{
	unsigned char state[4][4];
	int i, r, c;
...
void* AES::encryptData(void* input, int length)
{
...
void* AES::decryptData(void* input, int length)
{
	unsigned char* in = (unsigned char*)input;
	int i;
	for (i = 0; i < length; i += 16)
