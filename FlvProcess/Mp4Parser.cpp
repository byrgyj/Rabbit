...
Mp4Parser::Mp4Parser(void):mAudioData(NULL)
{
}
...
/*final box
 */
int Mp4Parser::mp4ReadMvhdBox(int size)  //level 3
{
    printf("\t+%s\n", "mvhd");
    VARIABLES;
...
/*final box
 */
mp4_tkhd_box Mp4Parser::mp4ReadTkhdBox(int size)  //level 4
{
    printf("\t\t+%s\n", "tkhd"); 
...
/*container box
  (elst)
 */
mp4_edts_box Mp4Parser::mp4ReadEdtsBox(FILE *f, int size)
{
    printf("\t\t+%s\n", "edts");
...
/*final box
 */
mp4_mdhd_box Mp4Parser::mp4ReadMdhdBox(int size)
{
    printf("\t\t\t+mdhd\n");
    mp4_mdhd_box box;
...
/*filnal box
 */
mp4_hdlr_box Mp4Parser::mp4ReadHdlrBox(int size)
{
    printf("\t\t\t%s\n", "+hdlr");
...
/*final box
 */
mp4_smhd_box *Mp4Parser::mp4ReadSmhdBox(int size)
{
    printf("\t\t\t\t+%s\n", "smhd");
    mp4_smhd_box box;
...
struct mp4_stts_box Mp4Parser::mp4ReadSttsBox(int size)  //level 8
{
    printf("\t\t\t\t\t+%s\n", "stts");
    mp4_stts_box box;
...
/*final box*/
mp4_avcC_box *Mp4Parser::mp4ReadAvccBox()
{
 ...
 */
mp4_avc1_box* Mp4Parser::mp4ReadAvc1Box(int size)  //level 9
{
...
/*final box
 */
mp4_mp4a_box * Mp4Parser::mp4ReadMp4aBox(int size)  //level 9
{
    printf("\t\t\t\t\t\t+mp4a\n");
    return 0;
}
...
/*container box
  (mp4a,avc1)
 */
mp4_stsd_box Mp4Parser::mp4ReadStsdBox(int size)  //level 8
{
    printf("\t\t\t\t\t+%s\n", "stsd");
    mp4_stsd_box box;
...
/*final box
 */
mp4_stss_box Mp4Parser::mp4ReadStssBox(int size)  //level 8
{
    printf("\t\t\t\t\t+%s\n", "stss");
    mp4_stss_box box;
    box.size              = size;
...
/*final box
 */
mp4_stsc_box Mp4Parser::mp4ReadStscBox(int size)  //level 8
{
    printf("\t\t\t\t\t+%s\n", "stsc");
...
/*final box
 */
mp4_stsz_box Mp4Parser::mp4ReadStszBox(int size)  //level 8
{
    printf("\t\t\t\t\t+%s\n", "stsz");
    mp4_stsz_box box;
...
/*final box
 */
mp4_stco_box Mp4Parser::mp4ReadStcoBox(int size)
{
    printf("\t\t\t\t\t+%s\n", "stco");
    mp4_stco_box box;
...
*/
mp4_stbl_box Mp4Parser::mp4ReadStblBox(int size)
{
    printf("\t\t\t\t+stbl\n");
...
/*container box
  ()
 */
struct mp4_dinf_box Mp4Parser::mp4ReadDinfBox(int size)
{
    printf("\t\t\t\t+dinf\n");
...
/*container box
  (vmhd, smhd, hmhd, nmhd)
*/
mp4_minf_box Mp4Parser::mp4ReadMinfBox(int size)
{
...
/*container box
  (mdhd, hdlr, minf)
*/
mp4_mdia_box Mp4Parser::mp4ReadMdiaBox(int size)
{
    printf("\t\t+%s\n", "mdia");
...
void Mp4Parser::mp4ReadTrakBox(int size)
{
    printf("\t+%s\n", "trak");
...
/*container box
  (mvhd, trak)
*/
void Mp4Parser::mp4ReadMoovBox(int size)   //level 2
{
    printf("+%s\n",  "mMoovBox");  
    mMoovBox.size             = size;
...
/*final box
 */
void Mp4Parser::mp4ReadFtypBox(int size)  //level 2
{
    printf("+ftyp\n");
...
/*@a special final box
 */
void Mp4Parser::mp4ReadMdatBox(int size)
{
    printf("\t+%s\n", "mdat");
...
/*container box
  (ftyp, free, mdat, moov)
*/
int Mp4Parser::mp4ReadRootBox() //level 1
{
    int k                 = 0;
    unsigned char p[5];
...
void Mp4Parser::print_trak(const struct mp4_trak_box * trak)
{
    printf("trak\n");
...
uint32_t Mp4Parser::getOffsetByTime(double seconds)
{
...
unsigned Mp4Parser::readUint16Big()
{
	unsigned short k = 0;
	mAudioData->readData(&k, sizeof(k));
	return k;
...
uint16_t Mp4Parser::readUint16Lit()
{
	uint16_t k;
	mAudioData->readData(&k, sizeof(k));
...
unsigned char Mp4Parser::readUint8()
{
	unsigned char x;
...
bool Mp4Parser::minfNeedToOffset(int curPos){
...
bool Mp4Parser::stblNeedToOffset(int curPos){
	mAudioData->setCurrentIndex(curPos + 4);
	char szHeader[5] = { 0 };
	mAudioData->readData(szHeader, 4);
	szHeader[4]= 0;
